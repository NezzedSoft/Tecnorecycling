        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              {/* Facebook */}
              <a href="https://www.facebook.com/tecnorecyclingpty" target="_blank" rel="noopener noreferrer" className="bg-gray-400 hover:bg-green-500 p-3 rounded-full transition-colors">
          ...
          <div>
            ...
            <ul className="text-gray-400 space-y-2">
              <li>
                <a href="mailto:tecnorecyclingpty@gmail.com" className="hover:text-white transition-colors">tecnorecyclingpty@gmail.com</a>
              </li>
              <li>
                <span>507 6190-5805</span>
              </li>
              <li>
                <span>Provincia de Panamá, Panamá</span>
              </li>
            </ul>
          </div>
        </div>
